...
from hky85geneconv import HKY85_GENECONV_Abstract
...
def main(args):
    ...
    abstract_model = HKY85_GENECONV_Abstract()
    guess = abstract_model.instantiate()
    guess.set_kappa(2.0)
    guess.set_tau(2.0)
    ...
    f = functools.partial(
            ...
            abstract_model,
            jsonctmctree.ll.process_json_in,
    ...
    m = abstract_model.instantiate(x_process)
    print('kappa:', m.kappa)
    print('tau:', m.tau)
